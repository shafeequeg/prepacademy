...
export default function Header() {
  ...
  return (
    <header className="w-full bg-gradient-to-r from-white via-[#F55D3E] to-[#a52a1a] shadow-lg py-4 rounded-xl">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <div className="flex items-center">
            <Image
              src="/Headerlogo.png" // Update this path with your logo
            ...
            <div className="relative">
              ...
              {isDropdownOpen && (
                <div className="absolute left-0 mt-2 bg-white shadow-lg rounded-lg w-48">
                  <a
                    href="#"
                    className="block text-gray-800 hover:text-[#F55D3E] px-4 py-2 text-sm"
                  >
                     Web Development
                  </a>
                  <a
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <nav className="md:hidden flex flex-col items-center bg-gray-100 py-4 space-y-4">
