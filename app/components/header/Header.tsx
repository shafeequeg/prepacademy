...
export default function Header() {
  ...
  const toggleDropdown = (e :React.MouseEvent<HTMLButtonElement | HTMLAnchorElement>) => {
    e.preventDefault();
    e.stopPropagation();
        ...
        <div className="container mx-auto">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex space-x-8 items-center">
              ...
              <div 
                ref={dropdownRef}
                className="split-dropdown relative"
              >
                <div className="flex">
                  <button
  ...
  <div className="nav-item relative group flex flex-col items-center" onClick={() => handleNavigation("/")}>
  ...
  <div className="nav-item relative group flex flex-col items-center" onClick={() => handleNavigation("/allcourses")}>
    <div className="p-2 rounded-full bg-orange-50 bg-opacity-20 hover:bg-opacity-40 transition-all duration-300 group-hover:scale-110">
      <svg className="w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <div className="nav-item relative group flex flex-col items-center" onClick={() => handleNavigation("/blogs")}>
    <div className="p-2 rounded-full bg-orange-50 bg-opacity-20 hover:bg-opacity-40 transition-all duration-300 group-hover:scale-110">
    <svg className="w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8h10M7 12h6m-4 8h8a2 2 0 002-2V6a2 2 0 00-2-2H7a2 2 0 00-2 2v12a2 2 0 002 2z" />
</svg>
  ...
  <div className="nav-item relative group flex flex-col items-center" onClick={() => window.open("https://test.prepacademy.in/", "_blank")}>
    <div className="p-2 rounded-full bg-orange-50 bg-opacity-20 hover:bg-opacity-40 transition-all duration-300 group-hover:scale-110">
      <svg className="w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <div className="nav-item relative group flex flex-col items-center" onClick={toggleSidebar}>
    <div className="p-2 rounded-full bg-orange-50 bg-opacity-20 hover:bg-opacity-40 transition-all duration-300 group-hover:scale-110">
      <svg className="w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
   ...
   {/* Overlay */}
<div 
  className={`fixed inset-0 bg-black bg-opacity-50 z-[99] ${isSidebarOpen ? 'block' : 'hidden'}`}
  onClick={toggleSidebar}
/>

{/* Sidebar */}
<div className={`fixed top-0 left-0 h-screen w-[80%] max-w-[320px] bg-gradient-to-br from-[#a52a1a] to-[#5D1A0F] z-[100] transform transition-transform duration-500 ease-in-out overflow-y-auto shadow-xl ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
  ...
  <div className="flex justify-between items-center px-6 py-5 border-b border-[#F55D3E]/30">
    ...
    <button onClick={toggleSidebar} className="text-[#FFE4B5] hover:text-white transition-colors">
      <FiX size={24} />
    </button>
  </div>
  ...
  <div className="mt-6 relative">
    ...
    <div className="px-6 py-3 text-[#FFE4B5] text-base font-serif italic font-bold tracking-wide">ALL COURSES</div>
  </div>
...
<div className="mt-6 relative">
    <div className="absolute left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#F55D3E] to-transparent"></div>
    <div className="px-6 py-3 text-[#FFE4B5] text-base font-serif italic font-bold tracking-wide">Get in Touch</div>
  </div>
  ...
  <div className="mt-6 relative">
    <div className="absolute left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#F55D3E] to-transparent"></div>
    <div className="px-6 py-3 text-[#FFE4B5] text-base font-serif italic font-bold tracking-wide">LEGAL HELP</div>
  </div>
  ...
  <div className="mt-6 relative">
    <div className="absolute left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#F55D3E] to-transparent"></div>
    <div className="px-6 py-3 text-[#FFE4B5] text-base font-serif italic font-bold tracking-wide">REACH OUT TO US</div>
  </div>
  ...
  <div className="px-6 py-3 my-2 mx-4 bg-[#F55D3E]/10 rounded-lg border border-[#F55D3E]/30 text-[#FFE4B5] text-sm   flex items-center">
    <svg className="w-4 h-4 mr-3 text-[#F55D3E]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <div className="px-6 py-3 text-[#FFE4B5]/70 text-sm font-serif italic leading-relaxed">
    ...
    3rd floor Alamparabil Building, <br />TK Road, Thiruvalla, Kerala 689101
  </div>
