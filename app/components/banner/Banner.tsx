      ...
      <div className="mt-4 w-full bg-[#130808] rounded-lg overflow-hidden">
        ...
        <div className="relative py-2 whitespace-nowrap">
          <div className="animate-marquee inline-block">
            <span className="mx-4 text-sm text-white font-medium"> <span className="m-2">•</span> CAT 2025 will likely be conducted on November 30, 2025</span>
            <span className="mx-4 text-sm  text-white  font-medium"><span className="m-2">•</span> JIPMAT (2025) Registration Window is Extended till 17th March 11:50 PM</span>
