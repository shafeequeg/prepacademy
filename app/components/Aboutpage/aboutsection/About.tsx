      ...
      <div className="bg-[#0c0f17] pt-6 pb-6 px-8 md:px-16">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold">
            <span className="text-[#ff6035]">About</span> <span className="text-white">Us</span>
          </h1>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between">
          <div className="w-full md:w-1/2 pr-0 md:pr-8">
            <h2 className="text-3xl font-bold mb-6">
              <span className="text-[#ff6035]">Welcome To</span> <span className="text-white">Prepacademy</span>
            </h2>
            <p className="text-gray-300 text-sm leading-relaxed max-w-xl">
              ...
              empower students with the knowledge and skills necessary 
              for lifelong success. As a trusted educational institution in 
              India, we focus on providing personalized learning 
              approaches tailored to meet the unique needs of every 
              student.
            </p>
          </div>
      ...
      <div className="bg-[#0c0f17] py-16 px-8 md:px-16">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            <span className="text-[#ff6035]">Why Choose</span> <span className="text-white">PrepAcademy?</span>
          </h2>
