...
const SuccessStories = () => {
  ...
  career counseling services and academic support.
      ...
      <div className="text-center mb-16">
        <a href="#" className="text-[#FF6B45] font-medium inline-flex items-center hover:text-[#ff8a6c] transition-colors">
          View More Photos
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
          <div className="md:max-w-md">
            <h3 className="font-serif text-2xl md:text-3xl lg:text-4xl leading-tight mb-4">
              <span className="text-[#FF6B45] italic">Looking For The Best</span><br />
              Educational Academy<br />
              Near You?
            </h3>
          </div>
          ...
          <div className="md:max-w-md">
            <p className="text-gray-300 mb-6">
              Join us today and discover how Prep Academy helps students achieve success. For more information, visit our
              website or contact us directly to learn more about our comprehensive career counseling and academic excellence
              programs.
            </p>
            <a 
              href="#" 
