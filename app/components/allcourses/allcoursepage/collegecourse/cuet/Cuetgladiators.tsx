        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              ...
              NTA Declares the Result/NTA Scores of Common University Entrance
              Test (UG) – 2024{" "}
            </p>
          </div>
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The National Testing Agency (NTA) has released the CUET UG 2025
              application form{" "}
            </p>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The registration process for the Common University Entrance
              Test-Undergraduate (CUET UG) 2025 is set to close soon, with the
