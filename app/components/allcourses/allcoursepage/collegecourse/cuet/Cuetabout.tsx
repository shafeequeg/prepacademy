  ...
  const faqs = [
    {
      ...
      answer:
        "Common University Entrance Test (CUET) UG is an entrance examination conducted for admission to undergraduation programs offered by various central, state, private and deemed universities.",
    },
    {
      question:
        "Is CUET compulsory for taking admission in central university?",
      answer:
        "Yes, CUET (Common University Entrance Test) is compulsory for admissions to undergraduate programs in most Central Universities in India. ",
    },
    {
      question: "	Where can I get the CUET UG syllabus?",
      answer:
        " Aspirants are strongly advised to review the university-specific CUET eligibility criteria on cuet.nta.nic.in to ensure they meet the admission requirements of their target institutions and syllabus.",
    },
    {
      question: "	Is the CUET exam tough?",
      answer:
        "The CUET exam is generally considered moderately difficult, but the perceived difficulty can vary based on individual preparation and subject strengths",
    },
  ];
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your CUET 2024 journey might
