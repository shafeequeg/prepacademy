        ...
        <div className="relative w-full bg-gradient-to-r p- from-[#0A1015] to-[#121820] text-white py-12 bg-center bg-no-repeat bg-cover ">
          <div className="w-full px-4 mt-24">
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <p className="text-gray-300 mb-8">
                    ...
                    national-level examination administered by the National
                    Testing Agency (NTA) for admissions into undergraduate (UG)
                    programs across various central and participating
                    universities in India. CUET (UG) 2025 will be conducted in
                    Computer-Based Test (CBT) mode from May 8 to June 1, 2025.
                  </p>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <p className="text-white">
                      Comprehensive CUET Online /Offline Course{" "}
                    </p>
                  </div>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              {/* Right Content - Form */}
              <AssistanceForm course="cuet(college-course)" />
            </div>
          </div>
        </div>
