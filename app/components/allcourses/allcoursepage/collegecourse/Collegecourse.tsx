        ...
        <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
          ...
          <div className="lg:w-[35%]">
            <div className="mb-6">
              ...
              <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">College Courses with
                 {/* Prep Academy  */}
                 <span className='text-[#ED1C24] ml-2'>Prep</span><span className='text-[#15938F]'>Academy</span>
                 </h2>
              <p className="text-gray-300 mb-8">
                Based on past trends, College Courses exam is expected to be held on the last Sunday of November 2025. The official notification is expected to be released towards the end of July 2025.
              </p>
            </div>
  ...
  <div className="flex justify-center">
   ...
   <div className="w-full bg-[#120B0B] py-8">
    ...
    <div className="w-full md:w-1/2 flex flex-col justify-center relative left-32">
      ...
      <p className="text-white  text-base md:text-2xl mb-6 max-w-lg pl-4">
