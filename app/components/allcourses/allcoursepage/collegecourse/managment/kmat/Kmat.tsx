...
const CUETExamApplySection: React.FC = () => {
  ...
  const handleEnrollClick = () => {
    router.push(`/CourseEnrollmentPortal#kmat`);
  };
  ...
  const relatedVideos = [
    {
      title: "Preparing for the KMAT 2025",
      videoId: "M33APKoNOqE", // Remove "&t=2s"
    },
    {
      title: "Strategies for KMAT 2025",
        ...
        <div className="relative w-full bg-gradient-to-r p- from-[#0A1015] to-[#121820] text-white py-12 bg-center bg-no-repeat bg-cover ">
          <div className="w-full px-4 mt-1">
            <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">
                    Crack KMAT 2025 with
                    {/* Prep Academy  */}
                    <span className="text-[#ED1C24] ml-2">Prep</span>
                    <span className="text-[#15938F]">Academy</span>
                  </h2>
                  <p className="text-gray-300 mb-8">
                    The Karnataka Management Aptitude Test (KMAT) is a
                    state-level examination administered by the Karnataka
                    Private Post Graduate Colleges Association (KPPGCA) for
                    admissions into MBA, PGDM, and MCA programs in Karnataka.
                    KMAT 2025 will be conducted in Remote Proctored
                    Internet-Based Test (IBT) mode, tentatively in October 2025.
                  </p>
                </div>
              ...
              {/* Right Content - Form */}
              <AssistanceForm course="kmat(college-course)" />
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3">
                  <h2 className="text-xl md:text-2xl font-bold text-center md:text-left">
                    Fast-Track Your KMAT Preparation
                  </h2>
                  <p className="text-center md:text-left mt-2 text-sm md:text-base">
                    You’re just one step away from starting expert-led training to boost your
                    KMAT score and secure admission to your desired management program.
                  </p>
                </div>
