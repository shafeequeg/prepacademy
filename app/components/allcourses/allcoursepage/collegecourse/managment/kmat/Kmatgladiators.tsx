...
const ExamPrepHomepage: React.FC = () => {
  ...
  const blogs = [
    ...
    {
      id: 2,
      title: "KMAT Exam Preparation: Ace the KMAT ",
      description: "Essential Tips and Resources for Exam Preparation",
      image: "/blogs/blog2.png",
    },
    {
      id: 3,
      title: "Important Study Hacks for KMAT 2025 Students",
      description: "Important Study Hacks for KMAT 2025 Students",
      image: "/blogs/blog3.png",
    },

    {
      id: 4,
      title: "KMAT 2025 Course",
      description: "KMAT 2025 Courses: Which One is Right for You?",
        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              ...
              KPPGCA has declared the Result/Scores of Karnataka Management
              Aptitude Test (KMAT) – 2024{" "}
            </p>
          </div>
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The Karnataka Private Post Graduate Colleges Association (KPPGCA)
              has released the KMAT 2025 application form{" "}
            </p>
            {/* <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The registration process for the Common University Entrance
              Test-Undergraduate KMAT 2025 is set to close soon, with the
              deadline for submitting applications being March 22, 2025 (11:50
              PM).{" "}
            </p> */}
          </div>
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
               The registration process for the Karnataka Management Aptitude
              Test (KMAT) 2025 is set to close soon, with the deadline for
              submitting applications expected by September 2025{" "}
            </p>
          </div>
