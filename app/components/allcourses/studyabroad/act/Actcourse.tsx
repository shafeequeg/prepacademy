...
const CatExamApplySection: React.FC = () => {
  ...
  const [activeMainTab, setActiveMainTab] = useState("ACT");
  ...
  const relatedVideos = [
    {
      title: "Preparing for the ACT 2025",
      videoId: "JNJOTlz8C2Y", // Remove "&t=2s"
    },
    {
      title: "Strategies for ACT 2025",
  ...
  const handleEnrollClick = () => {
    router.push(`/CourseEnrollmentPortal#act`);
  };
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <p className="text-gray-300 mb-8">
                    The ACT (American College Testing) is a standardized test
                    used for college admissions in the United States. It
                    evaluates a student’s readiness for college and provides
                    colleges with a common data point for comparing applicants.
                    ACT 2025 will be conducted in both Computer-Based and
                    Paper-Based formats on multiple national and international
                    dates throughout the year. Ace the ACT with our expert
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3">
                  <h2 className="text-xl md:text-2xl font-bold text-center md:text-left">
                    Fast-Track Your ACT Preparation
                  </h2>
                  <p className="text-center md:text-left mt-2 text-sm md:text-base">
                    You’re just one step away from expert coaching to boost your ACT score
