...
const ExamPrepLowerSections: React.FC = () => {
  ...
  const faqs = [
    {
      question: "What is the ACT exam? ",
      answer:
        "The ACT is a standardized college admissions test used primarily in the United States. It assesses students in English, Math, Reading, and Science, with an optional Writing section. ",
    },
    {
      question: "How often is the ACT conducted? ",
      answer:
        "The ACT is offered seven times a year in the U.S. and at select international locations on scheduled dates. Students can register for the date that best suits their timeline. ",
    },

    {
      question: "What is the difference between the ACT and SAT? ",
      answer: "Both ACT and SAT are college entrance exams. The ACT includes a Science section and allows less time per question, whereas the SAT emphasizes reasoning and includes more time per question. Colleges accept both equally. ",
    },

     {
      question: "What is a good ACT score? ",
      answer: "A good ACT score varies by college. The average ACT score is around 20-21, while top universities may require scores above 30. ",
    },

      {
      question: "Is the ACT exam difficult? ",
      answer: "The ACT is moderately challenging and requires a strong grasp of high school-level Math, English, and Reading, along with time management skills. ",
    },
    //  {
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your ACT journey might seem
