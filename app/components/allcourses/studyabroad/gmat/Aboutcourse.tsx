  ...
  const faqs = [
    {
      ...
      answer:
        "You can register for the GMAT through the official GMAT website (mba.com)",
    },
    {
      question: "	How often can I take the GMAT?",
      answer:
        "You can take the GMAT up to five times within a rolling 12-month period, but no more than eight times in total.",
    },
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your Gmat journey might seem
