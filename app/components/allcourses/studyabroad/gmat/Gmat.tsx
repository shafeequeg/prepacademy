              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">
                    Crack GMAT 2025 with
                    {/* Prep Academy  */}
                    <span className="text-[#ED1C24] ml-2">Prep</span>
                    <span className="text-[#15938F]">Academy</span>
                  </h2>
                  <p className="text-gray-300 mb-8">
                    GMAT (Graduate Management Admission Test) is a globally
                    recognized exam used for admissions to business schools and
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <p className="text-white">
                      Comprehensive GMAT Online /Offline Course{" "}
                    </p>
                  </div>
                </div>
                      ...
                      <div className="flex flex-col md:flex-row items-center">
                        ...
                        <div className="md:w-2/3">
                          ...
                          <p className="text-center md:text-left mt-2 text-sm md:text-base">
                            We are just a step away from finding the perfect
