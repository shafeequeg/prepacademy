  ...
  const faqs = [
    {
      ...
      answer:
        "The SAT is a standardized test designed to assess a high school student's readiness for college.",
    },
    {
      question: "How do I register for the SAT?",
      answer:
        "Registration for the SAT is conducted through the College Board's official website.",
    },
    ...
    },
    {
      ...
      answer:
        "It's advisable to begin SAT preparation at least 2–3 months before your scheduled test date.",
    },
  ];
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your Sat journey might seem
