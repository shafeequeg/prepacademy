        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              ...
              Registration for the SAT is currently open. To register, visit the
              College Board&apos;s official SAT registration page.{" "}
            </p>
          </div>
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              ...
              deadline—at least 30 days before test day.{" "}
            </p>
          </div>
