...
const CatExamApplySection: React.FC = () => {
  ...
  const relatedVideos = [
    {
      title: "Preparing for the IELTS 2025",
      videoId: "JNJOTlz8C2Y", // Remove "&t=2s"
    },
    {
      title: "Strategies for IELTS 2025",
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <p className="text-gray-300 mb-8">
                    ...
                    accepted by universities, employers, immigration
                    authorities, and professional bodies across English-speaking
                    countries. IELTS 2025 will be conducted in both
                    Computer-Based and Paper-Based formats throughout the year
                    at various test centers across India and worldwide. Ace the
                    IELTS with our expert coaching and study materials!
                  </p>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3">
                  <h2 className="text-xl md:text-2xl font-bold text-center md:text-left">
                    Fast-Track Your IELTS Preparation
                  </h2>
                  <p className="text-center md:text-left mt-2 text-sm md:text-base">
                    You’re just one step away from expert coaching to improve your IELTS
                    score and achieve your dreams of studying or working abroad.
                  </p>
                </div>
