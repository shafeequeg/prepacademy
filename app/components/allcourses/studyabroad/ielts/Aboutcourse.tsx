  ...
  const faqs = [
    {
      ...
      answer:
        "The IELTS (International English Language Testing System) is an English proficiency test for non-native English speakers. It is commonly required for study, work, and migration purposes in countries like the UK, Canada, Australia, and New Zealand. ",
    },
    {
      question: "Which IELTS test should I take? ",
      answer:
        "If you're applying for higher education or professional registration, you should take IELTS Academic. For migration or work experience, IELTS General Training is recommended. ",
    },

    {
      question: "How many times is IELTS conducted in a year? ",
      answer: "IELTS is conducted multiple times a month throughout the year. Candidates can choose their preferred date and location when booking the test. ",
    },
     {
      question: "Is there any age limit for IELTS? ",
      answer: "There is no official age limit for the IELTS exam, but it is generally recommended for candidates aged 16 and above. ",
    },

     {
      question: "What is the validity of the IELTS score? ",
      answer: " IELTS scores are valid for two years from the date of the test. ",
    }
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your IELTS journey might seem
