...
const CatExamApplySection: React.FC = () => {
  ...
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [activeMainTab, setActiveMainTab] = useState("GRE");
  ...
  const handleEnrollClick = () => {
    router.push(`/CourseEnrollmentPortal#gre`);
  };
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3">
                  <h2 className="text-xl md:text-2xl font-bold text-center md:text-left">
                    Fast-Track Your GRE Preparation
                  </h2>
                  <p className="text-center md:text-left mt-2 text-sm md:text-base">
                    You’re just one step away from expert coaching to boost your GRE score
                    and open doors to top graduate programs worldwide.
                  </p>
                </div>
