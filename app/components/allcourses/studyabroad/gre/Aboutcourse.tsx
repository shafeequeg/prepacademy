  ...
  const faqs = [
    {
      ...
      answer:
        "The GRE is a standardized test used for admissions into graduate and business school programs.",
    },
    {
      question: "How many times is GRE conducted in a year?",
      answer:
        "The GRE General Test is offered multiple times a year, allowing test-takers to take it once every 21 days",
    },

    {
      question: "How many attempts are allowed on the GRE?",
      answer:
        "As specified on the ETS website, candidates are limited to attempting the GRE exam five times within a rolling year",
    },
    //  {
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your Gre journey might seem
