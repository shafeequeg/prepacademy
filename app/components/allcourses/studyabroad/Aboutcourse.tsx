  ...
  const faqs = [
    {
      ...
      answer:
        "The last day for registering for CAT 2025 is September 20, 2025. Candidates must ensure they've completed all parts of their application by this deadline to avoid any disqualification or issues.",
    },
    {
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/5 border-r border-gray-800 pr-4">
              <ul className="space-y-4">
                <li className="text-orange-500  text-base md:text-lg py-1">
                  Beginners Guide
                </li>
                <li className="text-gray-400  text-base md:text-lg   py-1">
                  Study Plan
                </li>
                <li className="text-gray-400 text-base md:text-lg   py-1">
                  Syllabus
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between py-2 border-b border-gray-800">
                  <p className="text-white text-base md:text-lg ">
                    Beginner&apos;s Guide Volume 1
                  </p>
                  <a href="#" className="text-orange-500 text-base md:text-lg ">
                    Download File
                  </a>
                </div>
                <div className="flex items-center justify-between py-2 border-b border-gray-800">
                  <p className="text-white text-base md:text-lg ">
                    Beginner&apos;s Guide Volume 2
                  </p>
                  <a href="#" className="text-orange-500 text-base md:text-lg ">
                    Download File
                  </a>
        ...
        <div className="container-fluid mx-auto px-4 md:px-8 w-full">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your StudyAbroad journey might
