...
const tabs = [
    { id: "CLAT", label: "CLAT", path: "/schoolcourse-law/clat" },
    { id: "SLAT", label: "SLAT", path: "/slat" },
    { id: "AILET", label: "AILET", path: "/ailet" },
    { id: "KLEE", label: "KLEE", path: "/klee" },
    { id: "CULEE", label: "CULEE", path: "/culee" },
  ];
