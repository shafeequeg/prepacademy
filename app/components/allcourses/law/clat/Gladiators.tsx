        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              ...
              CLAT 2026 is tentatively scheduled for December 6, 2025, which
              aligns with the traditional first Sunday of December examination
              date.{" "}
            </p>
          </div>
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The application forms are expected to be available online starting
              in July 2025.{" "}
            </p>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
          ...
          <div>
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              ...
              Candidates must have completed their 10+2 or equivalent
              examination with a minimum of 45% marks (40% for SC/ST
              candidates). There is no upper age limit for UG courses.{" "}
            </p>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              <span className="text-lg">Postgraduate Programs (PG):</span>{" "}
              Applicants should hold an LL.B or equivalent degree with at least
              50% marks (45% for SC/ST candidates). There is no upper age limit
              for PG courses.{" "}
            </p>
          </div>
        </div>
