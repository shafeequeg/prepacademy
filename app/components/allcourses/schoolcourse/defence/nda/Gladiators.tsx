    ...
    <div className="flex flex-col min-h-screen  bg-gray-900 text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          <div className="mb-4  pb-4">
            <div className="text-white bg-[#FF6347] text-sm inline-block px-2 py-1 rounded mb-3">
              NDA & NA 2025 application form{" "}
            </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The Union Public Service Commission (UPSC) has released the NDA &
              NA 2025 application form.
            </p>
          </div>
          ...
          <div className="mb-4  pb-4">
            <div className="text-white bg-[#FF6347] text-sm inline-block px-2 py-1 rounded mb-3">
              Registration process last date{" "}
            </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The registration process for the National Defence Academy and
              Naval Academy Examination (NDA & NA) (I) 2025 closed on January 1,
              2025, with the deadline for NDA & NA (II) 2025 set for June 17,
              2025 (11:50 PM).
            </p>
          </div>
        </div>
