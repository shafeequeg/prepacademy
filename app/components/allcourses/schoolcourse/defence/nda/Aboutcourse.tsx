  ...
  const faqs = [
    {
      ...
      answer:
        "The National Defence Academy and Naval Academy Examination (NDA & NA) is an entrance examination conducted for admission to the Army, Navy, and Air Force wings of the National Defence Academy (NDA) and the Indian Naval Academy (INA) courses across India.",
    },
    {
      question:
        "Is NDA & NA Exam compulsory for taking admission in NDA or INA?",
      answer:
        "Yes, the NDA & NA Exam is compulsory for admissions to the National Defence Academy (NDA) and Indian Naval Academy (INA) courses, as it is the primary selection process conducted by UPSC.",
    },
    {
      question: "Where can I get the NDA & NA Exam syllabus?",
      answer:
        "Aspirants are strongly advised to review the NDA & NA Exam syllabus and eligibility criteria on upsc.gov.in to ensure they meet the admission requirements and prepare effectively.",
    },
    {
      question: "Is the NDA & NA Exam tough?",
      answer:
        "The NDA & NA Exam is generally considered moderately to highly difficult, depending on individual preparation, aptitude for mathematics, general knowledge, and performance in the SSB interview.",
    },
  ];
