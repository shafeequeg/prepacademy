        ...
        <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
          ...
          <div className="lg:w-[35%]">
            <div className="mb-6">
              ...
              <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">Crack NDA & NA Exam 2025 with
                 {/* Prep Academy  */}
                 <span className='text-[#ED1C24] ml-2'>Prep</span><span className='text-[#15938F]'>Academy</span>
                 </h2>
              <p className="text-gray-300 mb-8">
              The National Defence Academy and Naval Academy Examination (NDA & NA) is a national-level examination conducted by the Union Public Service Commission (UPSC) twice a year for admissions into the Army, Navy, and Air Force wings of the National Defence Academy (NDA) and the Indian Naval Academy (INA) courses across India.
NDA & NA (I) 2025 will be conducted in Pen-and-Paper mode on April 13, 2025, and NDA & NA (II) 2025 is scheduled for September 14, 2025.
Ace the NDA & NA Exam with our expert coaching and study materials!
...
/>
  ...
  className="w-5 h-5 mr-3"
/>
    <p className="text-white">Support for SSB Interview Preparation</p>
  </div>
</div>
...
/>
    ...
    <div className="lg:col-span-1.5 rounded-lg overflow-hidden bg-[#1F1414] relative flex flex-col justify-center items-center">
      ...
      <div className="p-8 flex flex-col items-center justify-center h-full">
        ...
        <h3 className="text-white text-center text-lg font-medium mb-5">NDA Master Class</h3>
        <a 
          href="#" 
