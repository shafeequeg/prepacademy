...
const ExamPrepLowerSections: React.FC = () => {
  ...
  const [openpointFaq, setpointOpenFaq] = useState<number | string | null>(
    null
  );

  const togglepointFaq = (id: number | string) => {
    setpointOpenFaq(openpointFaq === id ? null : id);
  };
  ...
  const faqs = [
    {
      question: "Which courses require Christ University Entrance Exams?",
      answer:
        "BBA, BCom (Hons.), BA LLB / BBA LLB, BHM,BA (Economics, Psychology, Journalism, etc.)",
    },
    {
      question:
        "	What is the eligibility to apply for Christ University Entrance Exams?",
      answer:
        ...
        <div className="container mx-auto">
          ...
          <div className="space-y-2">
            ...
            <div className="border-b border-gray-700">
              <button
                className="w-full flex items-center justify-between py-3 text-left"
                onClick={() => togglepointFaq("manual")}
              >
                <span className="text-base md:text-lg">
                  How can Prep academy help in Christ University Entrance Exams
                  preparation?
                </span>
                <span className="text-orange-500 text-xl">
                  {openpointFaq === "manual" ? "−" : "+"}
              ...
              {openpointFaq === "manual" && (
                <div className="pb-4 text-sm text-gray-400 pl-4">
                  <ul className="list-disc space-y-2">
                    <li>Expert-led live classes & recorded sessions</li>
                    <li>Full-length mock tests based on latest CUET pattern</li>
                    <li>Sectional tests for focused practice</li>
                    <li>Interview and micro-presentation prep modules</li>
                  </ul>
                </div>
              )}
            </div>
