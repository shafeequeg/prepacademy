...
const CatExamApplySection: React.FC = () => {
  ...
  const [activeMainTab, setActiveMainTab] = useState("OTHERS");
  const [openDropdown, setOpenDropdown] = useState<string | null>(null);
  const dropdownRefs = useRef<Record<string, HTMLDivElement | null>>({});

  const handleEnrollClick = () => {
    router.push(`/CourseEnrollmentPortal#christuniversity`);
  };
  ...
  const relatedVideos = [
    {
      title: "Preparing for the Christ University 2025",
      videoId: "JNJOTlz8C2Y", // Remove "&t=2s"
    },
    {
      title: "Strategies for  Christ University 2025",
        ...
        <div className="relative w-full bg-gradient-to-r p- from-[#0A1015] to-[#121820] text-white py-12 bg-center bg-no-repeat bg-cover ">
          <div className="w-full px-4 mt-1">
            <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">
                    Christ University 2025 with
                    {/* Prep Academy  */}
                    <span className="text-[#ED1C24] ml-2">Prep</span>
                    <span className="text-[#15938F]">Academy</span>
                  </h2>
                  <p className="text-gray-300 mb-8">
                    Christ University is one of India&apos;s premier private
                    institutions, known for academic excellence and holistic
                    development. The Christ University Entrance Test (CUET) is
                    conducted for admission into various undergraduate and
                    postgraduate programs including BBA, BCom, BHM, BA LLB, and
                    more.
                  </p>
                </div>
              ...
              {/* Right Content - Form */}
              <AssistanceForm course="neet-ug(medical)" />
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-1.5 rounded-lg overflow-hidden bg-[#1F1414] relative flex flex-col justify-center items-center">
              ...
              <div className="p-8 flex flex-col items-center justify-center h-full">
                ...
                <h3 className="text-white text-center text-lg font-medium mb-5">
                  Christ University Master Class
                </h3>
                <button
                  onClick={openModal}
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3">
                  <h2 className="text-xl md:text-2xl font-bold text-center md:text-left">
                    Discover Opportunities at Christ University
                  </h2>
                  <p className="text-center md:text-left mt-2 text-sm md:text-base">
                    Join a vibrant academic community that fosters excellence, innovation, and holistic development. Explore courses and programs tailored to help you achieve your career goals.
                  </p>
                </div>
