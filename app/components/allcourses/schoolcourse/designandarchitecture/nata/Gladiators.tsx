    ...
    GET EARLY ACCESS <ArrowRight size={16} className="ml-2" />
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          <div className="text-white bg-[#FF6347] text-sm inline-block px-2 py-1 rounded mb-3">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              	CoA Releases NATA 2025 Exam Schedule    
             </p>
          </div>
          ...
          <div className="mb-4  pb-4">
          <div className="text-white bg-[#FF6347] text-sm inline-block px-2 py-1 rounded mb-3">
           NATA 2025 application form        </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
        The Council of Architecture (CoA) has released the NATA 2025 application form.
             </p>
          ...
          Registration Details    </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
            The registration process for the National Aptitude Test in Architecture (NATA) 2025 began on February 3, 2025, with the deadline for submitting applications expected to be in June 2025 (exact date TBD).             </p>
