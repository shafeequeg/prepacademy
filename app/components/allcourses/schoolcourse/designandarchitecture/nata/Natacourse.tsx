        ...
        <div className="relative w-full bg-gradient-to-r p- from-[#0A1015] to-[#121820] text-white py-12 bg-center bg-no-repeat bg-cover ">
          <div className="w-full px-4 mt-1">
            <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <p className="text-gray-300 mb-8">
                    ...
                    national-level examination conducted by the Council of
                    Architecture (CoA) for admissions into undergraduate
                    programs, specifically the 5-year B.Arch (Bachelor of
                    Architecture) degree, across various architecture colleges
                    in India. NATA 2025 will be conducted in Computer-Based Test
                    (CBT) and offline mode from March 1, 2025, onwards, with
                    exams held every weekend until June 2025. Ace the NATA with
                    our expert coaching and study materials!
                  </p>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <p className="text-white">
                      Support for Drawing & Aptitude Preparation
                    </p>
                  </div>
                </div>
              ...
              {/* Right Content - Form */}
              <AssistanceForm course="Nata(architecture)" />
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3">
                  <h2 className="text-xl md:text-2xl font-bold text-center md:text-left">
                    Fast-Track Your NATA Preparation
                  </h2>
                  <p className="text-center md:text-left mt-2 text-sm md:text-base">
                    You’re just one step away from starting focused NATA coaching to enhance
                    your design skills and secure admission to your dream architecture college.
                  </p>
                </div>
