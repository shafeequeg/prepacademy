  ...
  const faqs = [
    {
      ...
      answer: "The National Aptitude Test in Architecture (NATA) is an entrance examination conducted for admission to undergraduate programs, specifically the 5-year B.Arch degree, offered by various architecture colleges across India."
    },
    {
      question: "	Is NATA compulsory for taking admission in architecture colleges?",
      answer: "Yes, NATA is compulsory for admissions to the B.Arch program in most architecture colleges in India, as it is a key requirement set by the Council of Architecture (CoA)."
    },
    {
      question: "	Where can I get the NATA syllabus?",
      answer: "Aspirants are strongly advised to review the NATA syllabus and eligibility criteria on nata.in to ensure they meet the admission requirements and prepare effectively."
    },
    {
      question: "Is the NATA exam tough?",
      answer: "The NATA exam is generally considered moderately to highly difficult, depending on individual preparation, creativity, drawing skills, and aptitude for architecture."
    }
  ];
