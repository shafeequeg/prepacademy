  ...
  const faqs = [
    {
      ...
      answer:
        "The Undergraduate Common Entrance Examination for Design (UCEED) is an entrance examination conducted for admission to undergraduate programs, specifically the Bachelor of Design (B.Des), offered by various IITs and other participating institutes across India.",
    },
    {
      question: "Is UCEED compulsory for taking admission in IITs for B.Des?",
      answer:
        "Yes, UCEED is compulsory for admissions to the B.Des program in participating IITs such as IIT Bombay, IIT Delhi, IIT Guwahati, IIT Hyderabad, IIT Indore, IIT Roorkee, and IIITDM Jabalpur, as it is the primary selection process conducted by IIT Bombay.",
    },
    {
      question: "	Where can I get the UCEED syllabus?",
      answer:
        " Aspirants are strongly advised to review the UCEED syllabus and eligibility criteria on uceed.iitb.ac.in to ensure they meet the admission requirements and prepare effectively.",
    },
    {
      question: "	Is the UCEED exam tough?",
      answer:
        "The UCEED exam is generally considered moderately to highly difficult, depending on individual preparation, creativity, design aptitude, and drawing skills.",
    },
  ];
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your UCEED journey might seem
