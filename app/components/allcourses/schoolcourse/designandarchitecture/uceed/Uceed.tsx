...
const CatExamApplySection: React.FC = () => {
  ...
  const relatedVideos = [
    {
      title: "Preparing for the UCEED 2025",
      videoId: "TCUxGkyrRp0", // Remove "&t=2s"
    },
    {
      title: "Strategies for UCEED 2025",
        ...
        <div className="relative w-full bg-gradient-to-r p- from-[#0A1015] to-[#121820] text-white py-12 bg-center bg-no-repeat bg-cover ">
          <div className="w-full px-4 mt-1">
            <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">
                    Crack UCEED 2025 with
                    {/* Prep Academy  */}
                    <span className="text-[#ED1C24] ml-2">Prep</span>
                    <span className="text-[#15938F]">Academy</span>
                  </h2>
                  <p className="text-gray-300 mb-8">
                    The Undergraduate Common Entrance Examination for Design
                    (UCEED) is a national-level examination conducted by the
                    Indian Institute of Technology (IIT) Bombay for admissions
                    into undergraduate programs, specifically the Bachelor of
                    Design (B.Des), across various IITs and other participating
                    institutes in India. UCEED 2025 was conducted in
                    Computer-Based Test (CBT) mode for Part-A and offline mode
                    for Part-B on January 19, 2025, from 9:00 AM to 12:00 PM.
                    Ace the UCEED with our expert coaching and study materials!
                  </p>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center">
                    ...
                    <p className="text-white">
                      {" "}
                      Support for Design & Drawing Preparation
                    </p>
                  </div>
                </div>
              ...
              {/* Right Content - Form */}
              <AssistanceForm course="uceed(architecture)" />
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3">
                  <h2 className="text-xl md:text-2xl font-bold text-center md:text-left">
                    Fast-Track Your UCEED Preparation
                  </h2>
                  <p className="text-center md:text-left mt-2 text-sm md:text-base">
                    You’re just one step away from starting focused coaching to enhance your
                    design skills and secure admission to top design institutes.
                  </p>
                </div>
