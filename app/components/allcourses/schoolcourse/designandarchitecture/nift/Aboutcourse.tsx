...
const ExamPrepLowerSections: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes, the NIFT Entrance Exam is mandatory for admission to all UG and PG programs at NIFT campuses. It replaced institute-specific processes and is now standardized under the NTA.",
    },
    {
      question: "Where can I get the NIFT Entrance Exam syllabus?",
      answer:
        "The syllabus is available on the official website exams.nta.ac.in/NIFT or nift.ac.in. GAT covers Quantitative Ability, Communication Ability, English Comprehension, Analytical Ability, and General Knowledge/Current Affairs. CAT assesses creativity, sketching, and design skills. Check program-specific details in the NIFT prospectus.",
    },
    {
      question: "Is the NIFT Entrance Exam tough?",
      answer:
        "The exam is considered moderately difficult.  GAT tests general aptitude (moderate, with a reportedly tough GK section in 2025), while CAT and the Situation Test evaluate creativity and practical skills, varying in difficulty based on preparation and artistic ability.",
    },
    {
      question: "How can I apply for NIFT 2025?",
      answer:
        "Applications were submitted online at exams.nta.ac.in/NIFT from November 22, 2024, to January 6, 2025 (late fee until January 9). Candidates registered, filled details, uploaded documents (photo, signature), and paid fees (₹3,000 for Open/EWS, ₹1,500 for SC/ST/PwD).",
    },
    {
      question: "When will NIFT 2025 results be declared?",
      answer:
        "Results were expected in late February or early March 2025 but are delayed. As of March 26, 2025, the NTA has not announced a specific date, though posts on X suggest an imminent release. Check exams.nta.ac.in/NIFT for updates.",
    },
  ];
        ...
        <div className="container mx-auto">
          ...
          <div className="space-y-2">
            ...
            <div className="border-b border-gray-700">
              ...
              >
                <span className="text-base md:text-lg">
                  What is the exam pattern for NIFT 2025?
                </span>
                <span className="text-orange-500 text-xl">
                  {openManualFaq ? "−" : "+"}
                </span>
              ...
              {openManualFaq && (
                <div className="pb-4 text-sm text-gray-400">
                  <ul className="list-disc pl-5">
                    <li>
                      GAT: CBT, 2 hours (B.Des/M.Des) or 3 hours
                      (B.F.Tech/M.F.Tech/MFM), with 100–150 MCQs (no negative
                      marking).
                    </li>
                    <li>
                      CAT: Offline, 3 hours, for B.Des/M.Des, testing sketching
                      and creativity.
                    </li>
                    <li>
                      Situation Test (B.Des): Hands-on, post-written exams,
                      assessing material handling.
                    </li>
                    <li>
                      Personal Interview (PG): For M.Des, MFM, M.F.Tech,
                      evaluating communication and aptitude.
                    </li>
                  </ul>
                </div>
              )}
            ...
            <div className="border-b border-gray-700">
              ...
              >
                <span className="text-base md:text-lg">
                  What are the eligibility criteria for NIFT 2025?
                </span>
                <span className="text-orange-500 text-xl">
                  {openManualFaqs ? "−" : "+"}
                </span>
              ...
              {openManualFaqs && (
                <div className="pb-4 text-sm text-gray-400">
                  <ul className="list-disc pl-5">
                    <li>
                      B.Des/B.F.Tech: Passed/appearing in Class 12 (B.F.Tech
                      requires Physics, Chemistry, Mathematics); max age 24 as
                      of August 1, 2025 (5-year relaxation for SC/ST/PwD).
                    </li>
                    <li>M.Des/MFM: Bachelor’s degree, no age limit.</li>
                    <li>
                      M.F.Tech: B.F.Tech or equivalent, no age limit. Check
                      nift.ac.in for specifics.
                    </li>
                  </ul>
                </div>
              )}
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your NIFT journey might seem
