        ...
        <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
          ...
          <div className="lg:w-[35%]">
            <div className="mb-6">
              ...
              <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">Crack NID 2025 with
                 {/* Prep Academy  */}
                 <span className='text-[#ED1C24] ml-2'>Prep</span><span className='text-[#15938F]'>Academy</span>
                 </h2>
              <p className="text-gray-300 mb-8">
              The National Institute of Design Design Aptitude Test (NID DAT) is a national-level examination administered by the National Institute of Design (NID) for admissions into undergraduate (B.Des) and postgraduate (M.Des) design programs across various NID campuses in India.
              NID DAT 2025 Prelims was conducted in Pen-and-Paper mode on January 5, 2025, with Mains for M.Des ongoing from March 3 to April 6, 2025, and B.Des Mains scheduled from April 26 to May 4, 2025.
              Ace the NID DAT with our expert coaching and study materials!
              </p>
            </div>
...
/>
  ...
  className="w-5 h-5 mr-3"
/>
    <p className="text-white">Support for Design Aptitude Preparation</p>
  </div>
</div>
...
/>
    ...
    <div className="lg:col-span-1.5 rounded-lg overflow-hidden bg-[#1F1414] relative flex flex-col justify-center items-center">
      ...
      <div className="p-8 flex flex-col items-center justify-center h-full">
        ...
        <h3 className="text-white text-center text-lg font-medium mb-5">NID Master Class</h3>
        <a 
          href="#" 
