...
const CatExamApplySection: React.FC = () => {
  ...
  const handleEnrollClick = () => {
    router.push(`/CourseEnrollmentPortal#nid`);
  };
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <p className="text-gray-300 mb-8">
                    The National Institute of Design Design Aptitude Test (NID
                    DAT) is a national-level examination administered by the
                    National Institute of Design (NID) for admissions into
                    undergraduate (B.Des) and postgraduate (M.Des) design
                    programs across various NID campuses in India. NID DAT 2025
                    Prelims was conducted in Pen-and-Paper mode on January 5,
                    2025, with Mains for M.Des ongoing from March 3 to April 6,
                    2025, and B.Des Mains scheduled from April 26 to May 4,
                    2025. Ace the NID DAT with our expert coaching and study
                    materials!
                  </p>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <p className="text-white">
                      Support for Design Aptitude Preparation
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3">
                  <h2 className="text-xl md:text-2xl font-bold text-center md:text-left">
                    Fast-Track Your NID Preparation
                  </h2>
                  <p className="text-center md:text-left mt-2 text-sm md:text-base">
                    You’re just one step away from beginning expert-led NID coaching to sharpen
                    your creative skills and secure admission to your dream design institute.
                  </p>
                </div>
