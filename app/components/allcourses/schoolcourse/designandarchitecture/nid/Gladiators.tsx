      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The National Institute of Design (NID) has released the NID DAT
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The registration process for the National Institute of Design
              Design Aptitude Test (NID DAT) 2025 closed on December 6, 2024
              (11:00 AM).
            </p>
          </div>
        </div>
