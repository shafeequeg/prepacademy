  ...
  const faqs = [
    {
      ...
      answer: "National Institute of Design Design Aptitude Test (NID DAT) is an entrance examination conducted for admission to undergraduate (B.Des) and postgraduate (M.Des) design programs offered by various NID campuses across India."
    },
    {
      question: "Is NID DAT compulsory for taking admission in NID?",
      answer: "Yes, NID DAT (Design Aptitude Test) is compulsory for admissions to design programs at National Institute of Design campuses in India."
    },
    {
      question: "Where can I get the NID DAT syllabus?",
      answer: "Aspirants are strongly advised to review the NID DAT syllabus and eligibility criteria on admissions.nid.edu to ensure they meet the admission requirements and prepare effectively."
    },
    {
      question: "Is the NID DAT exam tough?",
      answer: "The NID DAT exam is generally considered moderately to highly difficult, depending on individual creativity, design aptitude, and preparation level."
    }
  ];
