        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              ...
              NMIMS has started NPAT 2025 registration on February 20, 2025,
              with the application window open until May 26, 2025. Candidates
          ...
          <div className="mb-4  pb-4">
            <div className="text-white bg-[#FF6347] text-sm inline-block px-2 py-1 rounded mb-3">
              NPAT 2025 Exam Window{" "}
            </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The examination is scheduled from March 1 to May 31, 2025,
              allowing candidates up to three attempts (one main and two
              retakes), with the best score considered for admission.{" "}
            </p>
            {/* <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              Admit cards are issued immediately after scheduling an exam slot,
              available for download from the candidate&apos;s dashboard on the
              official website.
            </p>
            {/* <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
