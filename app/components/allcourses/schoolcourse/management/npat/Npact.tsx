        ...
        <div className="relative w-full bg-gradient-to-r p- from-[#0A1015] to-[#121820] text-white py-12 bg-center bg-no-repeat bg-cover ">
          <div className="w-full px-4 mt-1">
            <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">
                    Crack NPAT 2025 with
                    {/* Prep Academy  */}
                    <span className="text-[#ED1C24] ml-2">Prep</span>
                    <span className="text-[#15938F]">Academy</span>
                  </h2>
                  <p className="text-gray-300 mb-8">
                    The NMIMS Programs After Twelfth (NPAT) is a national-level
                    entrance examination conducted by the Narsee Monjee
                    Institute of Management Studies (NMIMS) for admissions into
                    undergraduate (UG) and integrated degree programs across its
                    various campuses in India, including Mumbai, Bengaluru,
                    Hyderabad, Navi Mumbai, Indore, Chandigarh, and Dhule. NPAT
                    2025 will be conducted in Computer-Based Test (CBT) mode
                    from March 1 to May 31, 2025.
                  </p>
                </div>
              ...
              {/* Right Content - Form */}
              <AssistanceForm course="npat(management)" />
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3">
                  <h2 className="text-xl md:text-2xl font-bold text-center md:text-left">
                    Fast-Track Your NPACT Preparation
                  </h2>
                  <p className="text-center md:text-left mt-2 text-sm md:text-base">
                    You’re just one step away from focused coaching to excel in the NPACT exam
                    and unlock opportunities in your desired career path.
                  </p>
                </div>
