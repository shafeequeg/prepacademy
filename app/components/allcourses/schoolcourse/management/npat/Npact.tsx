        ...
        <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
          ...
          <div className="lg:w-[35%]">
            <div className="mb-6">
              ...
              <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">Crack NPAT 2025 with
                 {/* Prep Academy  */}
                 <span className='text-[#ED1C24] ml-2'>Prep</span><span className='text-[#15938F]'>Academy</span>
                 </h2>
              <p className="text-gray-300 mb-8">
              The NMIMS Programs After Twelfth (NPAT) is a national-level entrance examination conducted by the Narsee Monjee Institute of Management Studies (NMIMS) for admissions into undergraduate (UG) and integrated degree programs across its various campuses in India, including Mumbai, Bengaluru, Hyderabad, Navi Mumbai, Indore, Chandigarh, and Dhule.
NPAT 2025 will be conducted in Computer-Based Test (CBT) mode from March 1 to May 31, 2025.
                           </p>
            </div>
