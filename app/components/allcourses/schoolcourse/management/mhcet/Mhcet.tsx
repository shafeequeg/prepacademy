...
const CatExamApplySection: React.FC = () => {
  ...
  const relatedVideos = [
    {
      title: "Preparing for the MHCET 2025",
      videoId: "JNJOTlz8C2Y", // Remove "&t=2s"
    },
    {
      title: "Strategies for MHCET 2025",
        ...
        <div className="relative w-full bg-gradient-to-r p- from-[#0A1015] to-[#121820] text-white py-12 bg-center bg-no-repeat bg-cover ">
          <div className="w-full px-4 mt-1">
            <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">
                    Crack MHCET 2025 with
                    {/* Prep Academy  */}
                    <span className="text-[#ED1C24] ml-2">Prep</span>
                    <span className="text-[#15938F]">Academy</span>
                  </h2>
                  <p className="text-gray-300 mb-8">
                    Prep Academy offers a specialized coaching program tailored
                    for aspirants aiming to excel in the Maharashtra Common
                    Entrance Test (MHT CET) for undergraduate programs in
                    engineering, pharmacy, and agriculture. The program is
                    meticulously designed to cover all sections of the MHT CET,
                    including Physics, Chemistry, Mathematics, and Biology,
                    depending on the candidate&apos;s chosen stream. With a
                    blend of live interactive sessions, recorded lectures,
                    comprehensive study materials, and regular mock tests, Prep
                    Academy ensures a holistic preparation approach. Their
                    experienced faculty focuses on concept clarity, time
                    management, and test-taking strategies to maximize students
                    performance.
                  </p>
                </div>
              ...
              {/* Right Content - Form */}
              <AssistanceForm course="mhcet(management)" />
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3">
                  <h2 className="text-xl md:text-2xl font-bold text-center md:text-left">
                    Fast-Track Your MHCET Preparation
                  </h2>
                  <p className="text-center md:text-left mt-2 text-sm md:text-base">
                    You’re just one step away from expert guidance to boost your MHCET score
                    and secure admission to top colleges in Maharashtra.
                  </p>
                </div>
