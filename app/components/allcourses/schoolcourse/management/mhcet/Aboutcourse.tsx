...
const ExamPrepLowerSections: React.FC = () => {
  ...
  const faqs = [
    {
      question: "What courses does Prep Academy's MH CET coaching cover?",
      answer:
        "Prep Academy's MHT CET coaching is designed for undergraduate programs in Engineering, Pharmacy, and Agriculture offered by institutions in Maharashtra.",
    },
    {
      question:
        "Is there any provision for doubt-clearing sessions?",
      answer:
        "Prep Academy offers regular doubt-clearing sessions where students can interact with faculty to resolve their queries.",
    },

    {
      question: "How can I enroll in the MHT CET coaching program?",
      answer:
        ": Interested candidates can enroll through Prep Academy's official website or contact their admissions team for guidance.",
    },
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your MHCET 2024 journey might
