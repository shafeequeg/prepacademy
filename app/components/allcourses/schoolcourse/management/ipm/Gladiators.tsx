        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              ...
              IIM Indore IPMAT 2025 Registration Began on February 14, 2025, and
              will conclude on March 27, 2025.{" "}
            </p>
          </div>
          ...
          <div className="mb-4  pb-4">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The Indian Institute of Management (IIM) Rohtak has announced that
              the registration for the Integrated Programme in Management
              Aptitude Test (IPMAT) 2025 is open until April 11, 2025.{" "}
            </p>
            {/* <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
