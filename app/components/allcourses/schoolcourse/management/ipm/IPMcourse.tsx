...
const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        ...
        <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
          ...
          <div className="lg:w-[35%]">
            <div className="mb-6">
              ...
              <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">Crack IPM 2025 with
                 {/* Prep Academy  */}
                 <span className='text-[#ED1C24] ml-2'>Prep</span><span className='text-[#15938F]'>Academy</span>
                 </h2>
              <p className="text-gray-300 mb-8">
              The Integrated Programme in Management (IPM) is a five-year course offered by select Indian Institutes of Management (IIMs), designed for students who have completed their 12th standard or equivalent. IPMAT 2025 is scheduled for May 12, 2025.              </p>
            </div>
  ...
  <div className="flex items-center">
    <img 
      ...
      className="w-5 h-5 mr-3"
    />
    <p className="text-white">Comprehensive IPM Online /Offline Course </p>
  </div>
</div>
                    ...
                    <div className="space-y-4 mb-6">
                      ...
                      <div className="relative">
                        ...
                        >
                          ...
                          <option value="CAT Preparation">IPM Preparation</option>
