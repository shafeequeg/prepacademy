...
const CatExamApplySection: React.FC = () => {
  ...
  const handleEnrollClick = () => {
    router.push(`/CourseEnrollmentPortal#ipm`);
  };
        ...
        <div className="relative w-full bg-gradient-to-r p- from-[#0A1015] to-[#121820] text-white py-12 bg-center bg-no-repeat bg-cover ">
          <div className="w-full px-4 mt-1">
            <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <p className="text-gray-300 mb-8">
                    The Integrated Programme in Management (IPM) is a five-year
                    course offered by select Indian Institutes of Management
                    (IIMs), designed for students who have completed their 12th
                    standard or equivalent. IPMAT 2025 is scheduled for May 12,
                    2025.{" "}
                  </p>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <p className="text-white">
                      Comprehensive IPM Online /Offline Course{" "}
                    </p>
                  </div>
                </div>
              ...
              {/* Right Content - Form */}
              <AssistanceForm course="ipm(management)" />
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3">
                  <h2 className="text-xl md:text-2xl font-bold text-center md:text-left">
                    Fast-Track Your IPM Preparation
                  </h2>
                  <p className="text-center md:text-left mt-2 text-sm md:text-base">
                    You’re just one step away from focused coaching to excel in the IPM exam
                    and secure admission to premier management programs.
                  </p>
                </div>
