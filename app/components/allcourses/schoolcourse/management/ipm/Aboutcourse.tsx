  ...
  const faqs = [
    {
      ...
      answer:
        "IPMAT is an entrance exam designed for students aspiring to join the five-year Integrated Programme in Management offered by IIMs, notably IIM Indore and IIM Rohtak.",
    },
    {
      question: " Who is eligible to apply for IPMAT?",
      answer:
        "TCandidates must have completed their Class 12 or equivalent examination from a recognized board.",
    },
    ...
    },
    {
      ...
      answer:
        "Yes, in both IIM Indore and IIM Rohtak exams, each correct answer awards 4 marks, and each incorrect answer results in a deduction of 1 mark.",
    },
  ];
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your IPM 2024 journey might
