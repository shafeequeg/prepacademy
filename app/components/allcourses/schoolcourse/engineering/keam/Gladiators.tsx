        ...
        <div className="bg-[#231515] rounded-lg p-8">
         ...
         Registration process       </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              ...
              The Commissioner of Entrance Examination (CEE) Kerala commenced the KEAM 2025 registration process on February 20, 2025                
                                     </p>
          </div>
          ...
          Late Date       </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The last date to submit the KEAM 2025 application form is March 10, 2025.
                </p>
          </div>
          ...
          <div className="text-white bg-[#FF6347] text-sm inline-block px-2 py-1 rounded mb-3">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
             KEAM 2025 examination is scheduled to be conducted between April 22 and April 30, 2025.                                         </p>
          </div>
        </div>
      </div>
