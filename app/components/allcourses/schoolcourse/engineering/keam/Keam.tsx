  ...
  return (
        ...
        <div className="relative w-full bg-gradient-to-r p- from-[#0A1015] to-[#121820] text-white py-12 bg-center bg-no-repeat bg-cover ">
          <div className="w-full px-4 mt-24">
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">
                    Crack KEAM 2025 with
                    {/* Prep Academy  */}
                    <span className="text-[#ED1C24] ml-2">Prep</span>
                    <span className="text-[#15938F]">Academy</span>
                  </h2>
                  <p className="text-gray-300 mb-8">
                    Getting into one of the top engineering colleges is a dream
                    for many but getting admitted to those isn&apos;t a cakewalk
                    and clearing the entrance exam is the gateway. KEAM is
                    administered by the Commissioner for Entrance Examinations
                    (CEE), Kerala, for admission to various professional degree
                    courses in the state, including engineering. PREP ACADEMY is
                    one of the promising KEAM coaching centers in Kerala. Our
                    faculties provide the best learning methods for the KEAM
                    examination. The candidates get complete training from our
                    experienced faculty members in regard to any queries in any
                    subject or the counselling process.
                  </p>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              <button className="border border-[#FF6B3D] text-[#FF6B3D] py-3 px-6 rounded-md font-medium hover:bg-[#FF6B3D] hover:text-white transition-colors" onClick={openModal}>
                Get a FREE Trial
              </button>
            </div>
              ...
              {/* Right Content - Form */}
              <AssistanceForm course="keam(school-course)" />
            </div>
          </div>
        </div>
    ...
    <div className="lg:col-span-1.5 rounded-lg overflow-hidden bg-[#1F1414] relative flex flex-col justify-center items-center">
      ...
      <div className="p-8 flex flex-col items-center justify-center h-full">
        ...
        <h3 className="text-white text-center text-lg font-medium mb-5">KEAM Master Class</h3>
        <a 
          href="#" 
          className="inline-block bg-[#F55D3E] text-white text-sm py-2 px-6 rounded hover:bg-[#F55D3E] hover:text-white transition-colors" onClick={openModal}
        >
          Book Free TRIAL
        </a>
      </div>
