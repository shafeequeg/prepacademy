        ...
        <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
          ...
          <div className="lg:w-[35%]">
            <div className="mb-6">
              ...
              <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">Crack KEAM 2025 with
                 {/* Prep Academy  */}
                 <span className='text-[#ED1C24] ml-2'>Prep</span><span className='text-[#15938F]'>Academy</span>
                 </h2>
              <p className="text-gray-300 mb-8">
              Getting into one of the top engineering colleges is a dream for many but getting admitted to those isn&apos;t a cakewalk and clearing the entrance exam is the gateway. KEAM is administered by the Commissioner for Entrance Examinations (CEE), Kerala, for admission to various professional degree courses in the state, including engineering.
              PREP ACADEMY is one of the promising KEAM coaching centers in Kerala. Our faculties provide the best learning methods for the KEAM examination. The candidates get complete training from our experienced faculty members in regard to any queries in any subject or the counselling process.
