              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-2/3">
                  <h2 className="text-xl md:text-2xl font-bold text-center md:text-left">
                    Fast-Track Your KEAM Preparation
                  </h2>
                  <p className="text-center md:text-left mt-2 text-sm md:text-base">
                    You’re just one step away from focused coaching to enhance your KEAM
                    performance and secure admission to your preferred engineering or medical college.
                  </p>
                </div>
