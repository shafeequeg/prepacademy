        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          Application window           </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              ...
              The KCET 2025 application window was open from January 23 to February 24, 2025. Candidates were required to complete the online application during this period.                         </p>
          </div>
          ...
          Admit cards          </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              	Registered candidates can download their admit cards from April 7, 2025, onwards through the official KEA website.   
  </p>
          </div>
          ...
          <div className="mb-4  pb-4">
          <div className="text-white bg-[#FF6347] text-sm inline-block px-2 py-1 rounded mb-3">
          Application correction facility         </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              KEA will provide an application correction facility, allowing candidates to rectify specific details in their submitted forms.
               The exact dates for this correction window will be announced on the official website.                                                 </p>
          </div>
        </div>
      </div>
