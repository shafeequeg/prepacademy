        ...
        <div className="relative w-full bg-gradient-to-r p- from-[#0A1015] to-[#121820] text-white py-12 bg-center bg-no-repeat bg-cover ">
          <div className="w-full px-4 mt-24">
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <p className="text-gray-300 mb-8">
                    ...
                    examination conducted by the Karnataka Examinations
                    Authority (KEA) for admission into various undergraduate
                    courses in engineering, pharmacy, agriculture, and other
                    professional programs within Karnataka. PREP ACADEMY is one
                    of the promising KCET coaching centers in Kerala. Our
                    faculties provide the best learning methods for the KCET.
                    The candidates get complete training from our experienced
                    faculty members in regard to any queries in any subject or
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              {/* Right Content - Form */}
              <AssistanceForm course="kcet(school-course)" />
            </div>
          </div>
        </div>
