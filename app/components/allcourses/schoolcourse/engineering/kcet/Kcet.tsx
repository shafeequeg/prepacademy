        ...
        <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
          ...
          <div className="lg:w-[35%]">
            <div className="mb-6">
              ...
              The Karnataka Common Entrance Test (KCET) is a state-level examination conducted by the Karnataka Examinations Authority (KEA) for admission into various undergraduate courses in engineering, pharmacy, agriculture, and other professional programs within Karnataka.

               PREP ACADEMY is one of the promising KCET coaching centers in Kerala. Our faculties provide the best learning methods for the KCET. The candidates get complete training from our experienced faculty members in regard to any queries in any subject or the counselling process.
              </p>
            </div>
...
/>
    ...
    <div className="lg:col-span-1.5 rounded-lg overflow-hidden bg-[#1F1414] relative flex flex-col justify-center items-center">
      ...
      <div className="p-8 flex flex-col items-center justify-center h-full">
        ...
        <h3 className="text-white text-center text-lg font-medium mb-5">KCET Master Class</h3>
        <a 
          href="#" 
