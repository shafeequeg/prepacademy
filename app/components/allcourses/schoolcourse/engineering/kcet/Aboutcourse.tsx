...
const ExamPrepLowerSections: React.FC = () => {
  ...
  const faqs = [
    {
      question: "	When is the KCET 2026 exam expected to be conducted?",
      answer:
        "The KCET 2026 exam is tentatively scheduled for December 6, 2025",
    },
    {
      question: "	When will the application process for KCET 2026 begin?",
      answer:
        "The application process for KCET 2026 is anticipated to commence in July 2025.",
    },
    {
      question: "How can I apply for KCET 2026?",
      answer:
        "Once the application process begins, candidates can apply online through the official KCET website.",
    },
    {
      question: "	Is there an age limit for appearing in KCET 2026?",
      answer:
        "There is no upper age limit for both undergraduate and postgraduate programs in KCET 2026.",
    },
  ];
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your KCET journey might seem
