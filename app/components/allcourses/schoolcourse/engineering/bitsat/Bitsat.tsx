        ...
        <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
          ...
          <div className="lg:w-[35%]">
            <div className="mb-6">
              ...
              <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">Crack BITSAT 2025 with
                 {/* Prep Academy  */}
                 <span className='text-[#ED1C24] ml-2'>Prep</span><span className='text-[#15938F]'>Academy</span>
                 </h2>
              <p className="text-gray-300 mb-8">
              The Birla Institute of Technology and Science Admission Test (BITSAT) is a computer-based entrance exam conducted by BITS Pilani for admissions to its integrated first-degree programs across campuses in Pilani, Goa, and Hyderabad.              </p>
            </div>
...
/>
    ...
    <div className="lg:col-span-1.5 rounded-lg overflow-hidden bg-[#1F1414] relative flex flex-col justify-center items-center">
      ...
      <div className="p-8 flex flex-col items-center justify-center h-full">
        ...
        <h3 className="text-white text-center text-lg font-medium mb-5">BITSAT Master Class</h3>
        <a 
          href="#" 
