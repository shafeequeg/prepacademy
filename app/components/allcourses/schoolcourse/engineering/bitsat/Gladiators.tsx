      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          Application Process         </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              	The BITSAT 2025 application process commenced on January 21, 2025.                
                        </p>
          </div>
          ...
          Application Deadline       </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              	 Candidates must submit their applications by April 18, 2025.  
                  </p>
          ...
          <div className="text-white bg-[#FF6347] text-sm inline-block px-2 py-1 rounded mb-3">
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              Session 1: May 26 to 30, 2025
                                                   </p>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              	Session 2: June 22 to 26, 2025     
                        </p>
          </div>
          ...
          Admit Card Availability
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
            The admit cards for Session 1 will be released on May 23, 2025.           
                          </p>
          </div>
          <div className="mb-4  pb-4">
          <div className="text-white bg-[#FF6347] text-sm inline-block px-2 py-1 rounded mb-3">
        Eligibility Criteria
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              Only students appearing for the 
              12th standard examination in 2025 or those who passed in 2024 are eligible to appear for BITSAT 2025.                        </p>
          </div>
        </div>
      </div>
