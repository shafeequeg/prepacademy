        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          Application Process           </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              ...
              The VITEEE 2025 application process has commenced. Candidates can apply online through the official VITEEE website.  
                                   </p>
          </div>
         ...
         Exam Date         </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The VITEEE 2025 examination is scheduled to be held tentatively from April 21 to 27, 2025
                                        </p>
            {/* <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
          ...
          <div>
            ...
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              	Applicants must have secured an aggregate of 60% or above in Physics, Chemistry, and Mathematics (PCM) or Physics, Chemistry, and Biology (PCB) in their 12th board examinations. For SC/ST candidates, the minimum required marks are 50%.                        </p>
