  ...
  return (
        ...
        <div className="relative w-full bg-gradient-to-r p- from-[#0A1015] to-[#121820] text-white py-12 bg-center bg-no-repeat bg-cover ">
          <div className="w-full px-4 mt-24">
              ...
              <div className="lg:w-[35%]">
                ...
                Learn from the Experts
                  ...
                  <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">
                    Crack VITEEE 2025 with
                    {/* Prep Academy  */}
                    <span className="text-[#ED1C24] ml-2">Prep</span>
                    <span className="text-[#15938F]">Academy</span>
                  </h2>
                  <p className="text-gray-300 mb-8">
                    VITEEE is a university-level exam conducted annually by the
                    Vellore Institute of Technology (VIT) for admission to its
                    undergraduate engineering programs across campuses in
                    Vellore, Chennai, Andhra Pradesh, and Bhopal. PREP ACADEMY
                    is one of the promising VITEEE coaching centers in Kerala.
                    Our faculties provide the best learning methods for the
                    VITEEE .The candidates get complete training from our
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              {/* Right Content - Form */}
              <AssistanceForm course="vitee(school-course)" />
            </div>
          </div>
        </div>
    ...
    <div className="lg:col-span-1.5 rounded-lg overflow-hidden bg-[#1F1414] relative flex flex-col justify-center items-center">
      ...
      <div className="p-8 flex flex-col items-center justify-center h-full">
        ...
        <h3 className="text-white text-center text-lg font-medium mb-5">VITEE Master Class</h3>
        <a 
          href="#" 
