        ...
        <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
          ...
          <div className="lg:w-[35%]">
            <div className="mb-6">
              ...
              <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">Crack VITEEE 2025 with
                 {/* Prep Academy  */}
                 <span className='text-[#ED1C24] ml-2'>Prep</span><span className='text-[#15938F]'>Academy</span>
                 </h2>
              <p className="text-gray-300 mb-8">
              VITEEE is a university-level exam conducted annually by the Vellore Institute of Technology (VIT) for
               admission to its undergraduate engineering programs across campuses in Vellore, Chennai, Andhra Pradesh, and Bhopal.
PREP ACADEMY is one of the promising VITEEE coaching centers in Kerala.
 Our faculties provide the best learning methods for the VITEEE .The candidates get complete training 
 from our experienced faculty members in regard to any queries in any subject or the counselling process.
              </p>
            </div>
