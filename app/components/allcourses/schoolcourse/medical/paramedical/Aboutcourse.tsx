  ...
  const faqs = [
    {
      ...
      answer:
        "We cover national and state-level paramedical entrance exams, including NEET (Allied Health), IPU CET, AIIMS Paramedical, and various state-specific exams.",
    },
    {
      question: "Is there an online course available?",
      answer:
        "Yes! We offer live online classes, recorded sessions, e-books, and doubt-clearing through chat support for remote students.",
    },

    {
      question: "Do you provide study materials and mock tests?",
      answer:
        " Absolutely. All enrolled students get updated notes, chapter-wise practice sheets, and full-length mock exams with analysis.",
    },
  ];
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your Paramedical 2025 journey
