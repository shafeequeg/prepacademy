  ...
  const faqs = [
    {
      ...
      answer:
        "JIPMER (Jawaharlal Institute of Postgraduate Medical Education & Research) conducts entrance exams for admission into MBBS and other health science programs in Puducherry and Karaikal.",
    },
    {
      question: "Is JIPMER still a separate exam from NEET?",
      answer:
        "Since 2020, JIPMER MBBS admissions are conducted via NEET-UG. However, we offer specialized prep for the JIPMER-based structure including subject focus and mock series.",
    },

    {
      question: "What subjects are covered in your JIPMER course?",
      answer:
        "Our course covers Biology, Chemistry, Physics, Logical Reasoning, and English Comprehension – the key components of the JIPMER pattern.",
    },
  ];
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your JIPMER 2025 journey might
