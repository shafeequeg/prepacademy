      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-[#231515] rounded-lg p-8">
          ...
          Application window        </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              	The application window was open from February 7
               to March 7, 2025. The correction window for applications was available from March 9 to March 11, 2025.  
         </p>
          </div>
          ...
          Syllabus        </div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              	The syllabus remains consistent with previous years, covering topics from Physics, Chemistry, and Biology based on the NCERT curriculum for Classes 11 and 12.  </p>
            {/* <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
          ...
          Exam Date</div>
            <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The NEET UG 2025 exam is scheduled to be conducted on May 4, 2025 as per the official announcement by the National Testing Agency (NTA).
Candidates can download their admit cards from the official NTA NEET website.
                          </p>
            {/* <p className="text-gray-300 text-base md:text-lg  flex">
              <span className="text-[#FF6347] mr-2">•</span>
              The Common Admission Test is the gateway for admissions to the MBA programs at top B-schools in India.
