  ...
  const faqs = [
    {
      ...
      answer:
        "NEET UG is conducted by the National Testing Agency (NTA) for admissions into MBBS, BDS, AYUSH, and other medical courses in India.",
    },
    {
      question: "	What is the eligibility for NEET UG 2025?",
      answer:
        "Candidates must have completed 10+2 with Physics, Chemistry, Biology, and English as mandatory subjects and must meet the required age and percentage criteria.",
    },

    {
      question: "How many times can I attempt NEET?",
      answer:
        " There is no limit on the number of attempts for NEET UG.. There is no limit on the number of attempts for NEET UG.",
    },

    {
      question: "What is the best way to prepare for NEET UG?",
      answer:
        " Enroll in Prep Academy's NEET coaching for expert guidance, structured study plans, mock tests, and personalized mentoring",
    },
  ];
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              Are you ready to conquer the world? Your Neet 2025 journey might
