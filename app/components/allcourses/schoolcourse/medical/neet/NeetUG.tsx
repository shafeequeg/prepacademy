        ...
        <div className="flex flex-col lg:flex-row gap-16 relative max-w-7xl mx-auto">
          ...
          <div className="lg:w-[35%]">
            <div className="mb-6">
              ...
              <h2 className="text-[#FF6B3D] text-4xl font-bold mb-4">Crack NEET(UG) 2025 with
                 {/* Prep Academy  */}
                 <span className='text-[#ED1C24] ml-2'>Prep</span><span className='text-[#15938F]'>Academy</span>
                 </h2>
              <p className="text-gray-300 mb-8">
              At Prep Academy, we provide comprehensive NEET UG coaching to help aspiring medical students achieve their dreams. Our expert faculty, well-structured curriculum, and rigorous practice sessions ensure that students are fully prepared to excel in the NEET UG exam. We focus on concept clarity, time management, and problem-solving skills, making learning both effective and engaging.
                           </p>
            </div>
