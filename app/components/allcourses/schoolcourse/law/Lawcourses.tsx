...
useEffect(() => {
  const handleScrollLock = (isOpen: boolean, isIPhoneDevice: boolean) => {
    if (isOpen) {
  ...
  if (isIPhoneDevice) {
    handleScrollLock(!!isIPhoneDropdownOpen, isIPhoneDevice);
  } else {
    handleScrollLock(!!openDropdown, isIPhoneDevice);
  }
...
if (!course) {
  ...
  return (
   ...
   <div
        className={`flex items-center w-full bg-black md:mt-24 lg:mt-32 mt-14 p-3 space-x-2 scrollbar-hide  ${
