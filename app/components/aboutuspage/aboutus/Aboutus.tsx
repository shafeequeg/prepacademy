        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center space-y-8 md:space-y-0">
          ...
          <div className="w-full md:w-3/5 md:pr-6 space-y-4">
            ...
            <p className="text-gray-300 text-base md:text-lg mb-6 max-w-lg">
              At Prep Academy, we go beyond traditional teaching methods we
              ignite curiosity, inspire excellence, and empower students to
              achieve their full potential. Our goal isn&apos;t just to help
              students pass exams but to transform their learning experience,
              sharpen their problem-solving skills, and equip them with the
              confidence to excel in competitive exams like CAT, CLAT, CUET,
              IPM, XAT, MAT, CMAT, KMAT, KLEE, NID, NIFT, NATA, NDA, SAT, GRE,
              and GMAT etc…
            </p>
            ...
            <div className="w-full flex justify-start mt-4  md:mt-16 z-10">
              <div
                className="w-full max-w-sm bg-gradient-to-r gradient-to-r from-[#2A1810] to-[#3A2820] 
      ...
      <section className="w-full bg-gradient-to-b from-[#1a0e0e] to-[#241010] py-20 px-4 md:px-8 relative">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between text-center md:text-left mt-8 px-4 md:px-8">
          ...
          <h4 className="text-gray-300 text-sm md:text-lg max-w-md leading-tight whitespace-pre-line relative px-6">
            ...
            <span>
              Behind every student&apos;s success are passionate,{" "}
        ...
        <div className="max-w-7xl mx-auto mt-12 md:mt-20 relative">
          ...
          <div className="overflow-hidden px-6 md:px-12">
            ...
            >
              ...
              {Array.from({
                length: Math.ceil(gladiators.length / (isMobile ? 2 : 4)),
              }).map((_, groupIndex) => (
                <div
                  key={groupIndex}
              ...
              {Array.from({
                ...
                <button
                  ...
                  className={`w-2 h-2 md:w-3 md:h-3 rounded-full ${
                    activeIndex === index || activeIndexsecond === index
                      ? "bg-[#FF6B45]"
                      : "bg-gray-500"
                  }`}
          ...
          <div className="overflow-hidden px-6 md:px-12">
            ...
            >
              ...
              {Array.from({
                length: Math.ceil(gladiatorssecond.length / (isMobile ? 2 : 4)),
              }).map((_, groupIndex) => (
                <div
                  key={groupIndex}
                  className="min-w-full flex justify-center px-2 md:px-4 flex-nowrap"
