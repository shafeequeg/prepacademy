...
export default function PrivacyPolicy() {
  return (
    <div className="bg-white min-h-screen">
      <Head>
        ...
        <meta name="description" content="Privacy Policy for PrepAcademy" />
      </Head>

      <main className="container mx-auto px-4 py-8 md:px-6 lg:px-8 max-w-5xl relative top-24">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-6 leading-relaxed">
            This website is operated by PrepAcademy. Throughout the site,
            the terms &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer to PrepAcademy. PrepAcademy offers this website,
          ...
          <p className="text-gray-700 mb-6 leading-relaxed">
            ...
            or use any services. If these Terms of Service are considered an offer, acceptance is expressly limited to
            these Terms of Service.
          </p>
          <p className="text-gray-700 mb-6 leading-relaxed">
            Any new features or tools which are added to the current store shall
            also be subject to the Terms of Service. You can review the most current version of the
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-6 leading-relaxed">
            ...
            inaccuracies or omissions, and to change or update information or cancel orders if any information in the Service or
            on any related website is inaccurate at any time without prior notice (including after you have submitted your order).
          </p>
          <p className="text-gray-700 mb-6 leading-relaxed">
  ...
  <p className="text-gray-700 mb-6 leading-relaxed">
    ...
    rights of others; (e) to harass, abuse, insult, harm, defame, slander, disparage, intimidate, or discriminate based 
    on gender, sexual orientation, religion, ethnicity, race, age, national origin, or disability; (f) to submit false 
    or misleading information; (g) to upload or transmit viruses or any other type of malicious code that will or may be 
    used in any way that will affect the functionality or operation of the Service or of any related website, other websites,
    or the Internet; (h) to collect or track the personal information of others; (i) to spam, phish, pharm, pretext, spider,
    crawl, or scrape; (j) for any obscene or immoral purpose; or (k) to interfere with or circumvent the security features
    of the Service or any related website, other websites, or the Internet. We reserve the right to terminate your use of 
...
<section className="mb-8">
  ...
  <p className="text-gray-700 mb-6 leading-relaxed">
    In no case shall PrepAcademy, our directors, officers, employees, affiliates, 
    ...
    whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of
    the service or any products procured using the service, or for any other claim related in any way to your use of the service 
    or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred
    as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service,
    even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability 
...
<section className="mb-8">
  ...
  <p className="text-gray-700 mb-6 leading-relaxed">
    You agree to indemnify, defend and hold harmless PrepAcademy and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys&apos; fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
  </p>
</section>
...
<section className="mb-8">
  ...
  <div className="flex flex-col">
    ...
    <Link href="mailto:info@prepacademy.in" className="text-pink-600 hover:underline mt-3 mb-24">
      info@prepacademy.in
    </Link>
  </div>
  <p className="text-gray-700 relative bottom-14 leading-relaxed">
    This document was last updated on November, 2023
  </p>
</section>
      </main>
    </div>
