...
<section>
  <h2 className="text-2xl font-bold text-gray-700 mb-4">Contact Forms</h2>
  <p className="text-lg leading-relaxed">
...
<section>
  <h2 className="text-2xl font-bold text-gray-700 mb-4">Report Downloads</h2>
  <p className="text-lg leading-relaxed">
...
<section>
  <h2 className="text-2xl font-bold text-gray-700 mb-4">Personal identification information</h2>
  <p className="text-lg leading-relaxed">
...
<section>
  <h2 className="text-2xl font-bold text-gray-700 mb-4">Non-personal identification information</h2>
  <p className="text-lg leading-relaxed">
...
<section>
  <h2 className="text-2xl font-bold text-gray-700 mb-4">How we protect information</h2>
  <p className="text-lg leading-relaxed">
...
<section>
  <h2 className="text-2xl font-bold text-gray-700 mb-4">What rights users have over their data</h2>
  <p className="text-lg leading-relaxed">
...
<section>
  <h2 className="text-2xl font-bold text-gray-700 mb-4">Sharing of personal information</h2>
  <p className="text-lg leading-relaxed">
...
<section>
  <h2 className="text-2xl font-bold text-gray-700 mb-4">Third party websites</h2>
  <p className="text-lg leading-relaxed">
...
<section>
  <h2 className="text-2xl font-bold text-gray-700 mb-4">Affiliate Links</h2>
  <p className="text-lg leading-relaxed">
...
<section>
  <h2 className="text-2xl font-bold text-gray-700 mb-4">Acceptance of these terms</h2>
  <p className="text-lg leading-relaxed">
...
<section>
  <h2 className="text-2xl font-bold text-gray-700 mb-4">Contacting us</h2>
  <p className="text-lg leading-relaxed">
